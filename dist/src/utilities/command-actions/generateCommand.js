import { generateSelectedComponents, isFullCRUDGeneration, } from './generators/components.js';
...
export async function generateCommand(modelName, options) {
    ...
    if (isFullCRUDGeneration(options)) {
        await generateFullCRUD(context.config, context.modelName, context.sliceFileExists, context.sliceDir, context.sagaDir ?? null, context.sliceFilePath, context.sagaFilePath ?? null, context.customSlicePath);
    }
    else {
